...
namespace TrailsFX {
    ...
    public partial class TrailEffect : MonoBehaviour {
        ...
        [FormerlySerializedAs("_active")] public bool Active = true;
        public bool active { get { return Active; } set { Active = value; if (!Active) wasInactive = true; } }
        ...
        void AddSnapshot() {
            if (!Active || (!theRenderer.enabled && !ignoreVisibility)) {
                wasInactive = true;
                return;
            }
